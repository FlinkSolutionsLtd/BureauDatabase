...
/* commented out 21/06/2019 by Ed - removing the reliance on fortnightly periods
with fts as
(
	...
	select cast('2019-06-17' as datetime) as dt, dateadd(day,13,cast('2019-06-17' as datetime)) as edt
